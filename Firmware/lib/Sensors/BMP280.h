...
class BMP280
{
	public:
		...
		char setFilter(unsigned char coeff);
		...
		char getTemperatureAndPressure(float& T,float& P);
	...
	private:
		...
		char readInt(char address, float &value);
		...
		char readUInt(char address, float &value);
		...
		char getUnPT(float &uP, float &uT);	
		...
		float dig_T1, dig_T2 , dig_T3 , dig_T4 , dig_P1, dig_P2 , dig_P3, dig_P4, dig_P5, dig_P6, dig_P7, dig_P8, dig_P9; 
