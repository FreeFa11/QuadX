...
public:
  ...
  /**
   * @fn Init
   * @brief set the spi chip select.
   * @param CSPin  bmi160 chip select
   * @return void
   */
  void ConfigSerial(SPIClass *SPIObj, int8_t CSPin);

  /**
   * @fn Init
   * @brief set the i2c addr.
   ...
   * @return void
   */
  void ConfigSerial(TwoWire *I2CObj, int8_t i2c_addr = BMI160_I2C_ADDR);
  ...
  private:
    int8_t Init(struct BMI160_Setting *dev);
    
    int8_t softReset(struct BMI160_Setting *dev);
    void   defaultParamSettg(struct BMI160_Setting *dev);
    
    int8_t setSensConf();
    int8_t setSensConf(struct BMI160_Setting *dev);
    
    int8_t setAccelConf(struct BMI160_Setting *dev);
    int8_t checkAccelConfig(uint8_t *data, struct BMI160_Setting *dev);
    int8_t processAccelOdr(uint8_t *data, struct BMI160_Setting *dev);
    int8_t processAccelBw(uint8_t *data, struct BMI160_Setting *dev);
    int8_t processAccelRange(uint8_t *data, struct BMI160_Setting *dev);

    int8_t setGyroConf(struct BMI160_Setting *dev);
    int8_t checkGyroConfig(uint8_t *data, struct BMI160_Setting *dev);
    int8_t processGyroOdr(uint8_t *data, struct BMI160_Setting *dev);
    int8_t processGyroBw(uint8_t *data, struct BMI160_Setting *dev);
    int8_t processGyroRange(uint8_t *data, struct BMI160_Setting *dev);

    int8_t setPowerMode(struct BMI160_Setting *dev);
    int8_t setAccelPwr(struct BMI160_Setting *dev);
    int8_t processUnderSampling(uint8_t *data, struct BMI160_Setting *dev);
    int8_t setGyroPwr(struct BMI160_Setting *dev);

    int8_t checkInvalidSettg( struct BMI160_Setting *dev);

    int8_t getSensorData(uint8_t select_sensor, struct BMI160_SensorData *accel, struct BMI160_SensorData *gyro,struct BMI160_Setting *dev);
    int8_t getAccelData(uint8_t len, struct BMI160_SensorData *accel, struct BMI160_Setting *dev);
    int8_t getGyroData(uint8_t len, struct BMI160_SensorData *gyro, struct BMI160_Setting *dev);
    int8_t getAccelGyroData(uint8_t len, struct BMI160_SensorData *accel, struct BMI160_SensorData *gyro, struct BMI160_Setting *dev);

    int8_t getRegs(uint8_t reg_addr, uint8_t * data, uint16_t len, struct BMI160_Setting *dev);
    int8_t setRegs(uint8_t reg_addr, uint8_t * data, uint16_t len, struct BMI160_Setting *dev);

    int8_t I2cGetRegs(struct BMI160_Setting *dev, uint8_t reg_addr, uint8_t *data, uint16_t len);
    int8_t I2cSetRegs(struct BMI160_Setting *dev, uint8_t reg_addr, uint8_t *data, uint16_t len);

    int8_t SPIGetRegs(struct BMI160_Setting *dev, uint8_t reg_addr, uint8_t *data, uint16_t len);
    int8_t SPISetRegs(struct BMI160_Setting *dev, uint8_t reg_addr, uint8_t *data, uint16_t len);

    
    int8_t setInt(struct BMI160_Setting *dev, int intNum);
    int8_t setIntConfig(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev);
    int8_t setAccelStepDetectInt(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev);
    int8_t enableStepDetectInt(struct bmi160AccStepDetectIntCfg *stepDetectIntCfg, struct BMI160_Setting *dev);
    int8_t setIntrPinConfig(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev);
    int8_t configIntOutCtrl(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev);
    int8_t configIntLatch(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev);
    int8_t mapFeatureInterrupt(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev);
    int8_t configStepDetect(struct bmi160AccStepDetectIntCfg *stepDetectIntCfg, struct BMI160_Setting *dev);

    int8_t setStepCounter(uint8_t step_cnt_enable, struct BMI160_Setting *dev);
    int8_t setStepPowerMode(uint8_t model,struct BMI160_Setting *dev);
    int8_t readStepCounter(uint16_t *stepVal, struct BMI160_Setting *dev);
    
    TwoWire *i2c_;
    SPIClass *spi_;
    struct BMI160_Setting* settings_;
    struct BMI160_SensorData* accel_;
    struct BMI160_SensorData* gyro_; 
};
