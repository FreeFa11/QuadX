...
BMI160::BMI160()
{
  settings_=(struct BMI160_Setting *)malloc(sizeof(struct BMI160_Setting));
  accel_= (struct BMI160_SensorData*)malloc(sizeof(struct BMI160_SensorData));
  gyro_ = (struct BMI160_SensorData*)malloc(sizeof(struct BMI160_SensorData));
}

void BMI160::ConfigSerial(SPIClass *SPIObj, int8_t CSPin)
{
  spi_ = SPIObj;
  settings_->interface = BMI160_SPI_INTF;
  settings_->id = CSPin;
}

void BMI160::ConfigSerial(TwoWire *I2CObj, int8_t i2c_addr)
{
  i2c_ = I2CObj;
  settings_->interface = BMI160_I2C_INTF;
  settings_->id = i2c_addr;
}
  
int8_t BMI160::Begin()
{
  return BMI160::Init(settings_);
}

int8_t BMI160::Init(struct BMI160_Setting *dev)
{
...
int8_t BMI160::softReset()
{
  ...
  rslt = softReset(settings_);
  return rslt;
}

int8_t BMI160::softReset(struct BMI160_Setting *dev)
{
  int8_t rslt=BMI160_OK;
...
void BMI160::defaultParamSettg(struct BMI160_Setting *dev)
{
...
{
  return BMI160::setSensConf(settings_); 
}

int8_t BMI160::setSensConf(struct BMI160_Setting *dev)
{
  int8_t rslt = BMI160_OK;
...
int8_t BMI160::setAccelConf(struct BMI160_Setting *dev)
{
  int8_t rslt = BMI160_OK;
  uint8_t data[2] = {0};
...
int8_t BMI160::checkAccelConfig(uint8_t *data, struct BMI160_Setting *dev)
{
  int8_t rslt;
...
int8_t BMI160::processAccelOdr(uint8_t *data,  struct BMI160_Setting *dev)
{
  int8_t rslt = 0;
  uint8_t temp = 0;
  uint8_t odr = 0;
...
int8_t BMI160::processAccelBw(uint8_t *data, struct BMI160_Setting *dev)
{
  int8_t rslt = 0;
  uint8_t temp = 0;
  uint8_t bw = 0;
...
int8_t BMI160::processAccelRange(uint8_t *data, struct BMI160_Setting *dev)
{
  int8_t rslt = 0;
  uint8_t temp = 0;
  uint8_t range = 0;
...
int8_t BMI160::setGyroConf(struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t data[2]={0};
...
int8_t BMI160::checkGyroConfig(uint8_t *data, struct BMI160_Setting *dev)
{
  int8_t rslt;
...
int8_t BMI160::processGyroOdr(uint8_t *data, struct BMI160_Setting *dev)
{
  int8_t rslt = 0;
  uint8_t temp = 0;
  uint8_t odr = 0;
...
int8_t BMI160::processGyroBw(uint8_t *data, struct BMI160_Setting *dev)
{
  int8_t rslt = 0;
  uint8_t temp = 0;
  uint8_t bw = 0;
...
int8_t BMI160::processGyroRange(uint8_t *data, struct BMI160_Setting *dev)
{
  int8_t rslt = 0;
  uint8_t temp = 0;
  uint8_t range = 0;
...
int8_t BMI160::setPowerMode(struct BMI160_Setting *dev)
{
  int8_t rslt = 0;
...
int8_t BMI160::setAccelPwr(struct BMI160_Setting *dev)
{
  int8_t rslt = 0;
  uint8_t data = 0;
...
int8_t BMI160::processUnderSampling(uint8_t *data, struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t temp = 0;
...
int8_t BMI160::setGyroPwr(struct BMI160_Setting *dev)
{
  int8_t rslt = 0;
...
int8_t BMI160::checkInvalidSettg( struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t data = 0;
...
int8_t BMI160::getSensorData(uint8_t type, int16_t* data)
{
  int8_t rslt=BMI160_OK;
  if (type==onlyAccel){
    rslt = getSensorData(BMI160_ACCEL_SEL, accel_, NULL, settings_);
    if(rslt == BMI160_OK){
      data[0]=gyro_->x;
      data[1]=gyro_->y;
      data[2]=gyro_->z;
    ...
    rslt = getSensorData(BMI160_GYRO_SEL, NULL, gyro_, settings_); 
    if(rslt == BMI160_OK){
      data[0]=accel_->x;
      data[1]=accel_->y;
      data[2]=accel_->z;
    ...
    rslt = BMI160::getSensorData((BMI160_ACCEL_SEL | BMI160_GYRO_SEL),accel_, gyro_, settings_);
    if(rslt == BMI160_OK){
      data[0]=gyro_->x;
      data[1]=gyro_->y;
      data[2]=gyro_->z;
...
{
  int8_t rslt = BMI160_OK;
  rslt = getSensorData((BMI160_ACCEL_SEL | BMI160_GYRO_SEL),accel_, gyro_, settings_);
  if(rslt == BMI160_OK){
    data[0]=gyro_->x;
    data[1]=gyro_->y;
    data[2]=gyro_->z;
...
int8_t BMI160::getSensorData(uint8_t select_sensor, struct BMI160_SensorData *accel, struct BMI160_SensorData *gyro,struct BMI160_Setting *dev)
{
  int8_t rslt = BMI160_OK;
  uint8_t time_sel;
  uint8_t sen_sel;
...
int8_t BMI160::getAccelData(uint8_t len, struct BMI160_SensorData *accel, struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t idx = 0;
...
int8_t BMI160::getGyroData(uint8_t len, struct BMI160_SensorData *gyro, struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t idx = 0;
...
int8_t BMI160::getAccelGyroData(uint8_t len, struct BMI160_SensorData *accel, struct BMI160_SensorData *gyro, struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t idx = 0;
  uint8_t data_array[15] = {0};
...
int8_t BMI160::getRegs(uint8_t reg_addr, uint8_t *data, uint16_t len, struct BMI160_Setting *dev)
{
...
int8_t BMI160::setRegs(uint8_t reg_addr, uint8_t *data, uint16_t len, struct BMI160_Setting *dev)
{
  int8_t rslt = BMI160_OK;
  uint8_t count = 0;
  //Null-pointer check
...
int8_t BMI160::I2cGetRegs(struct BMI160_Setting *dev, uint8_t reg_addr, uint8_t *data, uint16_t len)
{
  i2c_->beginTransmission(dev->id);
  i2c_->write(reg_addr);
  i2c_->endTransmission(true);
  delay(1);
  i2c_->requestFrom(dev->id, uint8_t(len));
  i2c_->readBytes(data, len);

  return BMI160_OK;
}

int8_t BMI160::I2cSetRegs(struct BMI160_Setting *dev, uint8_t reg_addr, uint8_t *data, uint16_t len)
{
...
int8_t BMI160::SPIGetRegs(struct BMI160_Setting *dev, uint8_t reg_addr, uint8_t *data, uint16_t len)
{
  digitalWrite(dev->id, LOW);
  spi_->transfer(reg_addr | BMI160_SPI_RD_MASK);
  spi_->transferBytes(nullptr, data, len);
  
  digitalWrite(dev->id,HIGH);
  return BMI160_OK;
}

int8_t BMI160::SPISetRegs(struct BMI160_Setting *dev, uint8_t reg_addr, uint8_t *data, uint16_t len)
{  
  digitalWrite(dev->id, LOW);
  spi_->transfer(reg_addr & BMI160_SPI_WR_MASK);
  spi_->transferBytes(data, nullptr, len);
...
{
  return setInt(settings_,intNum);  
}

int8_t BMI160::setInt(struct BMI160_Setting *dev, int intNum)
{
  int8_t rslt=BMI160_OK;
  if (dev == NULL){
    rslt = BMI160_E_NULL_PTR;
...
int8_t BMI160::setIntConfig(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev)
{
  int8_t rslt = BMI160_OK;
...
int8_t BMI160::setAccelStepDetectInt(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev)
{
  int8_t rslt = BMI160_OK;
...
int8_t BMI160::enableStepDetectInt(struct bmi160AccStepDetectIntCfg *stepDetectIntCfg, struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t data = 0;
  uint8_t temp = 0;
...
int8_t BMI160::setIntrPinConfig(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev)
{
  int8_t rslt;
...
int8_t BMI160::configIntOutCtrl(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t temp = 0;
  uint8_t data = 0;
...
int8_t BMI160::configIntLatch(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t temp = 0;
  uint8_t data = 0;
...
int8_t BMI160::mapFeatureInterrupt(struct bmi160IntSettg *intConfig, struct BMI160_Setting *dev)
{
  int8_t rslt;
...
int8_t BMI160::configStepDetect(struct bmi160AccStepDetectIntCfg *stepDetectIntCfg, struct BMI160_Setting *dev)
{
  int8_t rslt;
  uint8_t temp = 0;
...
{
  return BMI160::setStepPowerMode(model,settings_);
}

int8_t BMI160::setStepPowerMode(uint8_t model,struct BMI160_Setting *dev)
{
  int8_t rslt = BMI160_OK;
...
int8_t BMI160::setStepCounter()
{
  ...
  return BMI160::setStepCounter(step_enable,settings_);
}

int8_t BMI160::setStepCounter(uint8_t step_cnt_enable, struct BMI160_Setting *dev)
{
  int8_t rslt = BMI160_OK;
  uint8_t data = 0;
...
{
  return readStepCounter(stepVal,settings_);
}

int8_t BMI160::readStepCounter(uint16_t *stepVal, struct BMI160_Setting *dev)
{
  int8_t rslt = BMI160_OK;
  uint8_t data[2] = {0, 0};
  uint16_t msb = 0;
